...
export default function AdminPage() {
  ...
  return <div className="control-center-page">
    <div className="control-center-hero">
      ...
      <div className="control-center-links"><Link href="/admin/home-banners">Баннеры главной</Link><Link href="/admin/governance">Голосования</Link><Link href="/admin/moderation">Апелляции</Link><Link href="/admin/workshop">Мастерская</Link><Link href="/admin/reviews">Отзывы</Link><Link href="/admin/media">Медиа</Link></div>
    </div>
