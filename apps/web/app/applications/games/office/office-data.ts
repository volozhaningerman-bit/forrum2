...
export const officeNavigation: OfficeNavigationItem[] = [
  ...
  { icon: 'task', label: 'Задачи', hint: 'Все действия, которые тратят энергию и дают награды.' },
  { icon: 'career', label: 'Карьера', hint: 'Путь развития, должности и будущие профессии.' },
  { icon: 'company', label: 'Компания', hint: 'Работодатели, офисы, зарплата и переходы.' },
  { icon: 'achievement', label: 'Боссы', hint: 'Начальники, испытания и карьерные проверки.' },
  { icon: 'character', label: 'Персонаж', hint: 'Билд, внешний вид и синергии персонажа.' },
  { icon: 'shop', label: 'Магазин', hint: 'Вернись в офис и выбери предмет прямо на сцене.' },
];
