...
export default function SubscriptionsPage() {
  ...
  return <div className="personal-library-layout"><main>
    ...
    <div className="library-tabs" role="tablist"><button type="button" className={tab === 'authors' ? 'active' : ''} onClick={() => setTab('authors')} type="button">Авторы <span>{authors.length}</span></button><button type="button" className={tab === 'tags' ? 'active' : ''} onClick={() => setTab('tags')} type="button">Хэштеги <span>{tags.length}</span></button></div>
