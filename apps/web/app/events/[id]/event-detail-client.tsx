...
export function EventDetailClient({
  ...
  const [data, setData] =
    useState<EventDetail | null>(initialData); const [error, setError] = useState(''); const [message, setMessage] = useState('');
